public class DoublyCircularListTester {
	public static void main(String[] args) {

		System.out.println("\n/////  Test 01  /////");
		Object[] a1 = { 10, 20, 30, 40 };
		DoublyCircularList h1 = new DoublyCircularList(a1); // Creates a linked list using the values from the array
		...
		System.out.println("\n/////  Test 02  /////");
		// returns the reference of the Node at the given index. For invalid idx return
		// null.
		...
		DoublyCircularList h2 = new DoublyCircularList(a2); // uses the first constructor: LinkedList(Object [] a)
		...
		DoublyCircularList h3 = new DoublyCircularList(a3); // uses the first constructor: LinkedList(Object [] a)
